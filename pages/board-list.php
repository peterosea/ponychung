    ...
    <div class="row">
      <div class="filter_wrap">
        <div class="row align-items-center">
          ...
          <div class="col col-lg-6 flex_row view_count">
        ...
        <table class="table_list theme_red">
          ...
          <tbody>
            <tr>
              <td class="_num">10</td>
              <td class="_title">
                <a href="/pages/board-single.php">제5회 민연 젊은 한국학 아카데미 온라인 개최 안내</a>
              </td>
            ...
            <tr>
              <td class="_num">4</td>
              <td class="_title">
                <a href="/pages/board-single.php">2020 포니정재단 학술지원 연구과제 공모 (+FAQ) 안내</a>
              </td>
              <td class="_author">관리자</td>
              <td class="_date">2021.02.28</td>
            </tr>
            <tr>
              <td class="_num">3</td>
              <td class="_title">
                <a href="/pages/board-single.php">2020 포니정 인문연구장학 모집 공고</a>
              </td>
              <td class="_author">관리자</td>
              <td class="_date">2021.02.28</td>
            </tr>
            ...
            <tr>
              <td class="_num">1</td>
              <td class="_title">
                <a href="/pages/board-single.php">2020 포니정재단 학술지원 연구과제 공모 (+FAQ)
              </td>
              <td class="_author">관리자</td>
              <td class="_date">2021.02.28</td>
            </tr>
