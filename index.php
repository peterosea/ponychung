...
<?php include 'includes/head.php'?>
    ...
    <div class="content_container home_content">
        <div class="inner_container con_width flex_row">
            <div class="col_1_3 col_3 sect_announce">
                <div class="inner_col flex_col">
                    ...
                    <div class="announce_wrap flex_col">
                        <div class="cat flex_row">
                            <div class="_active _nav_btn">장학</div>
                            <div class="bar_vert"></div>
                            <div class="_nav_btn">주거지원장학</div>
                        </div>
                        <div class="_contents flex_col">
                            <a href="#" class="text_wrap flex_col _active">
                                <div class="_title">
                            ...
                            <a href="#" class="text_wrap flex_col">
                                <div class="_title">
                                    <h1>2021 포니정 인문연구장학 모집</h1>
                                </div>
                                <p class="_parag">
