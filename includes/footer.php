<footer class="main_footer">
    <div class="container site_width flex_row">
        <div class="flex_col col_1_2">
            ...
            <div class="flex_col copyright">
                <span class="grey_style">
                04377 서울특별시 용산구 한강대로 23길 55 포니정재단 &nbsp;&nbsp;&nbsp;&nbsp; COPYRIGHT © PONY CHUNG FOUNDATION. ALL RIGHT RESERVED.
                </span>
            </div>
        </div>
        <div class="flex_row col_2_2">
            <ul class="foot_side_menu flex_row">
                <li class="item _fb">
                    <a href="#" target="_blank">
                        <svg version="1.1" id="svg_fb" class="ic_sns" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        ...
                        <span class="_text">페이스북</span>
                    </a>
                </li>
                <li class="item _blog">
                    <a href="#" target="_blank">
                        <svg version="1.1" id="svg_blog" class="ic_sns" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        y="0px" viewBox="0 0 21.5 18.1" style="enable-background:new 0 0 21.5 18.1;" xml:space="preserve">
                            <g transform="translate(-269.73 -951.173)">
                        ...
                        <span class="_text">블로그</span>
                    </a>
                </li>
                <li class="item _insta">
                    <a href="#" target="_blank">
                        <svg version="1.1" id="svg_insta" class="ic_sns" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        y="0px" viewBox="0 0 18.1 18.1" style="enable-background:new 0 0 18.1 18.1;" xml:space="preserve">
                            <g transform="translate(-319.188 -951.256)">
                        ...
                        <span class="_text">인스타그램</span>
                    </a>
                </li>
                <li class="shortcut">
                    <a href="#" target="_blank">포니정재단 바로가기</a>
                </li>
            </ul>
        </div>
    </div>
